  ...
  return (
    ...
    >
      <Link
        ...
        aria-label={`Открыть шаблон «${template.title}» в режиме просмотра`}
      ...
      >
        <div className="relative aspect-[4/3] overflow-hidden bg-surface-2">
          <img
            ...
            loading="lazy"
            decoding="async"
            className="size-full object-contain object-center transition-transform duration-500 ease-out group-hover:scale-[1.03]"
          />
